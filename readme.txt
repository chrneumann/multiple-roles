...
= 1.3.8 =
* 13th july 2026
* SECURITY FIX: Fix get_validated_roles_from_post() so it actually returns the validated/filtered roles instead of the raw, unvalidated POST data, and correctly checks submitted role slugs against editable roles
